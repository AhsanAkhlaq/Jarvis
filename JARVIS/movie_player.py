    ...
    def player(self):
        ...
        while(i<1):
            ...
            if (len(movie_index) == 1) :
                ...
                speak(("Playing movie " + movie_name[0]))
                os.startfile(path + movie_list[0])
                continue 
            elif(movie_index != []):
                print_list(movie_name)
                ...
                try:
                    ...
                    if choice < len(movie_list):
                        ...
                        speak(("Playing movie " + movie_name[choice]))
                ...
                speak(("Playing movie " + random_name))
